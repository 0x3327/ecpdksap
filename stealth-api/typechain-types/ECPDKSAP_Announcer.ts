...
export interface ECPDKSAP_AnnouncerInterface extends Interface {
  getFunction(
...
export interface ECPDKSAP_Announcer extends BaseContract {
  connect(runner?: ContractRunner | null): ECPDKSAP_Announcer;
  waitForDeployment(): Promise<this>;

  interface: ECPDKSAP_AnnouncerInterface;
